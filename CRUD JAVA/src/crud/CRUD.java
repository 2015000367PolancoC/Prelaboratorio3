...
public class CRUD extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            PreparedStatement pst = cn.prepareStatement("insert into empleado(Nombres,Apellidos,Fechanacimiento,Direccion,Telefono,Email)values(?,?,?,?,?,?);");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try
            {
            PreparedStatement pst = cn.prepareStatement("update empleado set Nombres = ?, Apellidos = ?, Fechanacimiento = ?, Direccion = ?, telefono = ?, email = ? where id = "+jTextField4.getText());
    ...
    try
    {
        PreparedStatement pst = cn.prepareStatement("delete from empleado where id = "+jTextField4.getText());
        int a = pst.executeUpdate();
        if(a>0){
